...
public class OfferDao {
	...
	public static List<Offer> getAllOffer() throws SQLException {
		...
		try {
			...
			String sql = "select channel_name,validity,price,start_date,expiry_date from offer";
			...
			while (rst.next()) {
				...
				Offer listOffer = new Offer(channelName, price, validity, startDate, expiryDate);
